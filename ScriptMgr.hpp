...
namespace Vega
{
	...
	class Script {
	public:
		explicit Script(Func func, std::optional<std::size_t> StackSize = std::nullopt) : m_Func(func), m_ScriptFiber(nullptr), m_MainFiber(nullptr) {
...
#define JobStart(...) Vega::g_FiberPool->QueueJob([__VA_ARGS__] {
#define JobEnd });